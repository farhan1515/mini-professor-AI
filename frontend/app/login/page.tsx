...
import { Bot, BookOpen, GraduationCap, LineChart, Mic, Shield } from "lucide-react";
            ...
            <div className="relative z-10 w-full min-h-screen flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-[50%] lg:w-[45%] flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12 text-white">
                    ...
                    <h1 className="text-4xl md:text-5xl font-[800] leading-tight mb-4">
                        Your professor,<br />available 24/7
                    </h1>
                    <p className="text-white/80 text-lg mb-10 font-medium leading-relaxed">
                        Welcome Back. Please sign in to your UWindsor account.
                    </p>
                    ...
                    <div className="space-y-4 w-full max-w-md">
                        ...
                        <div className="flex justify-between items-center text-sm font-medium text-white/80 py-2">
                            <label className="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" className="w-4 h-4 rounded border-0 bg-white/20 text-gold focus:ring-0 cursor-pointer" />
                        ...
                        <button
                            onClick={handleLogin}
                            disabled={loading}
                            className="w-32 h-12 bg-[#1A1A2E] hover:bg-black text-white rounded-xl font-bold transition-all shadow-lg mt-2 disabled:opacity-70 flex items-center justify-center gap-2 hover:-translate-y-0.5"
                        >
                        ...
                        <div className="mt-8 pt-6 border-t border-white/10">
                            <p className="text-sm text-white/70 font-medium">
                                ...
                                <Link href="/register" className="text-white font-bold hover:text-gold transition-colors ml-1">
                                    Create your account
                                </Link>
                            </p>
                        </div>
                ...
                <div className="hidden md:flex w-full md:w-[50%] lg:w-[55%] items-center justify-center p-12 relative pointer-events-none">
                    <div className="relative w-[500px] h-[500px]">
                        ...
                        <div className="absolute top-[18%] right-[2%] w-24 h-24 bg-white shadow-xl rounded-full flex items-center justify-center border border-border z-10 transition-transform">
